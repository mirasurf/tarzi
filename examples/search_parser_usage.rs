use tarzi::search::{
    SearchEngine, SearchEngineType, ParserFactory, CustomParserConfig, SearchResultParser
};
    ...
    fn parse(&self, _html: &str, limit: usize) -> tarzi::Result<Vec<tarzi::search::SearchResult>> {
        ...
        for i in 0..mock_results_count {
            ...
            results.push(SearchResult {
                ...
                snippet: format!("This is a custom search result snippet from {} for result #{}", self.name, rank),
                rank,
            });
        }
