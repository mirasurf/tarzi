    ...
    tokio::time::timeout(test_timeout, async {
        ...
        match result {
            ...
            Err(e) => {
                ...
                println!(
                    "Self-managed Firefox driver test passed - Correct error for unavailable drivers: {error_msg}"
                );
            }
        }
    })
    ...
    tokio::time::timeout(test_timeout, async {
        ...
        match result {
            ...
            Err(e) => {
                ...
                assert!(!error_msg.contains("External WebDriver"));
                println!(
                    "Self-managed Chrome driver test passed - Correct error for unavailable drivers: {error_msg}"
                );
            }
        }
    })
