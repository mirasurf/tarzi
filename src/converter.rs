...
mod tests {
    ...
    async fn test_html_to_json() {
        ...
        let html = "<h1>Test Title</h1><p>Test content with <a href=\"https://example.com\">link</a>.</p>";
        ...
        assert!(result.contains("\"content\":"), "JSON should contain a content field");
    }
    ...
    async fn test_html_to_yaml() {
        ...
        // Test with title and content
        let html = "<h1>YAML Test</h1><p>YAML content with <a href=\"https://test.com\">link</a>.</p>";
        ...
        assert!(result.contains("content:"), "YAML should contain a content field");
    }
    ...
    async fn test_parse_html_document() {
        ...
        assert_eq!(document.links, vec!["https://link1.com", "https://link2.com"]);
