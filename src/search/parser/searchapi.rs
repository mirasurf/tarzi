    ...
    fn parse(&self, html: &str, limit: usize) -> Result<Vec<SearchResult>> {
        ...
        for i in 0..mock_results_count {
            ...
            let result = SearchResult {
                ...
                snippet: format!("This is a mock SearchApi search result snippet for result {}. In a real implementation, this would be extracted from the HTML using appropriate CSS selectors.", rank),
                rank,
            };
        ...
        info!("Successfully parsed {} SearchApi search results", results.len());
